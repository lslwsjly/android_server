...
CREATE TABLE `user` (
  ...
  `realname` varchar(45) DEFAULT '' COMMENT '真实姓名',
  ...
  `department` varchar(45) DEFAULT NULL COMMENT '院系',
  `grade` int(11) NOT NULL DEFAULT '0' COMMENT '年级',
  `stunum` varchar(45) DEFAULT NULL COMMENT '学号',
...
INSERT INTO `user` VALUES (1,'2@2.com','123','2222','real','2222','2,3',1,2,'2222',2,'2222','2222',2),(5,'juju@163.com','123',NULL,'','juju','1',0,0,NULL,0,NULL,NULL,1);
...
-- Dump completed on 2014-12-20  1:14:35
