...
(function(w){
    ...
    heatmap.prototype = {
        ...
        drawAlpha: function(x, y, count, colorize){
                ...
                ctx.shadowBlur = Math.floor(radius / 20 * 15); 
...
/*==============================以上部分为heatmap.js的核心代砿,只负责热力图的展玿====================================*/
 ...
 * 主入口类昿<a href="symbols/BMapLib.Heatmap.html">Heatmap</a>＿
 * 基于Baidu Map API 2.0〿
 *
...
/**
 * @namespace BMap的所有library类均放在BMapLib命名空间丿
 */
...
(function() {
     ...
     * 
     * @constructor
     * @param {Json Object} opts 可选的输入参数，非必填项。可输入选项包括＿<br />
     * {"<b>radius</b>" : {String} 热力图的半径,
     * <br />"<b>visible</b>" : {Number} 热力图是否显礿,
     * <br />"<b>gradient</b>" : {JSON} 热力图的渐变区间,
     * <br />"<b>opacity</b>" : {Number} 热力的透明庿,
     *
     * @example <b>参考示例：</b><br />
     * var map = new BMap.Map("container");<br />map.centerAndZoom(new BMap.Point(116.404, 39.915), 15);<br />var heatmapOverlay = new BMapLib.HeatmapOverlay({"radius":10, "visible":true, "opacity":70});<br />heatmapOverlay.setDataSet(data);//data是热力图的详细数捿
     */
    ...
    /**
     * 设置热力图展现的配置
     * @param {Json Object} options 可选的输入参数，非必填项。可输入选项包括＿<br />
     * {"<b>radius</b>" : {String} 热力图的半径,
     * <br />"<b>visible</b>" : {Number} 热力图是否显礿,
     * <br />"<b>gradient</b>" : {JSON} 热力图的渐变区间,
     * <br />"<b>opacity</b>" : {Number} 热力的透明庿,}
